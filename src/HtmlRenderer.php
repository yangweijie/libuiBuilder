...
class HtmlRenderer
{
     ...
     * @throws Exception
     */
    public static function render(string $htmlFile, array $handlers = [], array $variables = []): ComponentBuilder
    {
        $renderer = new self();
    ...
    private function renderSeparator(DOMElement $element): SeparatorBuilder
    {
        ...
        return $orientation === 'vertical' ? Builder::vSeparator() : Builder::hSeparator();
    }
